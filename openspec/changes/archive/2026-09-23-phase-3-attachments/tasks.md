...
- [x] 6.3 Push a branch and verify the preview; apply the attachments migrations to prod; merge to `main` and verify attaching an image and a file on production
